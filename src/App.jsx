...
const TOURS = [{"id": "goree", "pole": "Dakar", "name": "Goree Island — Memory & Heritage", "dur": "Half day", "tag": "Heritage", "emoji": "🏛️", "zone": "dakar", "desc": "Ferry crossing to the UNESCO island: House of Slaves, colonial lanes, artists' quarter. Senegal's #1 site.", "quote": false, "grid": {"p12": {"a": 1000, "c": 1000}, "p34": {"a": 1000, "c": 1000}, "grp": {"a": 1000, "c": 1000}}, "sub": "Standard departure from client hotel · Dakar port ferry terminal · sea crossing 3.5 km / ~25 min · total 3h30–4h", "steps": ["Pick-up at hotel, transfer to Port Autonome ferry terminal (Liaison Maritime Dakar-Gorée)  ·  5–10 km / 20–30 min", "Check-in and boarding (tickets pre-purchased by ATS; verify current timetable weekly)", "Ferry crossing to Goree  ·  3.5 km / 25 min", "Guided walk: harbour square → House of Slaves & Door of No Return (interior visit)| Colonial quarter walk: Saint-Charles church |Sand painting demonstration | Artists' village and baobab square  |Guns of Navarone  ·  90 min", "Return ferry  ·  25 min", "Transfer back to hotel — end of service  ·  20–30 min"], "addons": [{"name": "Seafront lunch on Goree (menu, per person)", "price": 12000, "per": "person"}, {"name": "Goree museums entry (IFAN Historical / Fort d’Estrées)", "price": 3000, "per": "booking"}, {"name": "Extended night stay", "price": null, "per": "booking"}]}, {"id": "city", "pole": "Dakar", "name": "Dakar City Tour", "dur": "Half Day", "tag": "Culture", "emoji": "🌆", "zone": "dakar", "desc": "Plateau, Medina, Soumbédioune and the corniche in a private vehicle — Dakar decoded in an afternoon.", "quote": false, "grid": {"p12": {"a": 65000, "c": 30000}, "p34": {"a": 30000, "c": 15000}, "grp": {"a": 20000, "c": 10000}}, "sub": "Departure 09:00 or 14:30 · private vehicle · ~30 km urban loop · 3h30–4h", "steps": ["Pick-up; Place de l'Indépendance and colonial administrative quarter (drive + short walk)  ·  3 km / 30 min", "Cathedrale church  ·  15 min", "Soumbedioune fishing beach and craft market  ·  30 min", "Corniche Ouest: Mosque of the Divinity photo stop  ·  45 min", "African Renaissance Monument outdoor  ·  45 min", "Corniche viewpoints → drop-off at hotel or restaurant  ·  5 km / 30 min"], "addons": [{"name": "Lunch at a Senegalese restaurant (reservation + menu)", "price": 12000, "per": "booking"}, {"name": "Iconic ‘car rapide’ rental for the tour (per vehicle)", "price": 35000, "per": "booking"}, {"name": "Extension: Renaissance Monument interior photo stop", "price": 6000, "per": "booking"}]}, {"id": "monument", "pole": "Dakar", "name": "African Renaissance Monument", "dur": "2–3 h visit", "tag": "Heritage", "emoji": "🗿", "zone": "dakar", "desc": "Africa's tallest statue at Ouakam — a short, high-impact visit with panoramic city views.", "quote": false, "grid": {"p12": {"a": 10000, "c": 6000}, "p34": {"a": 8000, "c": 5000}, "grp": {"a": 7000, "c": 4000}}, "sub": "Departure 09:00 or 15:30 · Ouakam, 10 km / 25 min from Plateau hotels · sold separately or combined with the Museum of Black Civilizations", "steps": ["Pick-up; drive to Ouakam  ·  10 km / 25 min", "Exterior approach and history briefing at the foot of the 52 m monument  ·  20 min", "Inside visit of the monument, Panoramic view of Ouakam  ·  45 min"], "addons": [{"name": "Combine with the Museum of Black Civilisations (combined half-day rate)", "price": 5000, "per": "booking"}, {"name": "Ouakam fishing village", "price": null, "per": "booking"}]}, {"id": "museum", "pole": "Dakar", "name": "Museum of Black Civilizations", "dur": "2–3 h visit", "tag": "Heritage", "emoji": "🖼️", "zone": "dakar", "desc": "The landmark Museum of Black Civilizations on the Plateau (closed Mondays).", "quote": false, "grid": {"p12": {"a": 6000, "c": 5000}, "p34": {"a": 6000, "c": 4000}, "grp": {"a": 6000, "c": 3000}}, "sub": "Departure 09:30 or 14:30 · Plateau · closed Mondays (verify) · sold separately or combined with the Renaissance Monument", "steps": ["Pick-up; drive to the museum (Plateau)  ·  3–10 km / 15–25 min", "Curated guided route : origins of humankind, African civilizations, contemporary works.  ·  90 min"], "addons": [{"name": "Combine with the Renaissance Monument (combined half-day rate)", "price": 7000, "per": "booking"}, {"name": "IFAN Museum extension (+1 h)", "price": 6000, "per": "booking"}]}, {"id": "monmus", "pole": "Dakar", "name": "Combined: Monument + Museum of Black Civilizations", "dur": "Half day", "tag": "Heritage", "emoji": "🗿", "zone": "dakar", "desc": "The Monument and the Museum of Black Civilizations combined at one rate in a single half day.", "quote": false, "grid": {"p12": {"a": 13000, "c": 10000}, "p34": {"a": 13000, "c": 10000}, "grp": {"a": 13000, "c": 10000}}, "sub": "Departure 09:00 · ~25 km total · 4 h · the combined option of Monument + Museum at one rate", "steps": ["Renaissance Monument program: visit and panoramic deck  ·  10 km / 100 min on site", "Drive Ouakam → Plateau  ·  12 km / 30 min", "Museum of Black Civilisations  ·  90 min", "Return transfer — end of service  ·  15–25 min"], "addons": [{"name": "IFAN Museum extension (+1 h)", "price": 5000, "per": "booking"}, {"name": "Lunch downtown after the museum", "price": 12000, "per": "booking"}]}, {"id": "ngor", "pole": "Dakar", "name": "Ngor Island Escape", "dur": "Half day", "tag": "Beach", "emoji": "🛶", "zone": "dakar", "desc": "A 5-minute pirogue crossing to a car-free island of coves, surf and grilled fish.", "quote": false, "grid": {"p12": {"a": 20000, "c": 15000}, "p34": {"a": 18000, "c": 10000}, "grp": {"a": 15000, "c": 7000}}, "sub": "Departure 09:30 or 14:00 · pirogue crossing 400 m / 5 min · 3h30–4h", "steps": ["Pick-up; drive to Ngor village beach  ·  14 km / 30–40 min", "Traditional pirogue crossing to the island  ·  5 min", "Guided island loop: lanes, art houses, ocean-side viewpoint over the surf break  ·  60 min", "Free time: swim on the sheltered beach / café  ·  60–90 min", "Pirogue return + transfer to hotel  ·  45 min"], "addons": [{"name": "Seafood lunch on the island (per person)", "price": 12000, "per": "person"}, {"name": "Jet-ski session", "price": 25000, "per": "booking"}, {"name": "Canoe / kayak hire", "price": 6000, "per": "booking"}, {"name": "Combine with the Dakar City Tour into a full day", "price": 20000, "per": "booking"}]}, {"id": "lacrose", "pole": "Dakar", "name": "Lac Rose (Pink Lake) Discovery", "dur": "Half or full day", "tag": "Nature", "emoji": "🌸", "zone": "dakar", "desc": "Salt harvesters, dunes and the famous pink water, 40 km from Dakar by toll road.", "quote": false, "grid": {"p12": {"a": 40000, "c": 25000}, "p34": {"a": 35000, "c": 20000}, "grp": {"a": 30000, "c": 15000}}, "sub": "Departure 08:30 (half) / 09:00 (full) · 40 km via toll road · 1h–1h15 each way", "steps": ["Pick-up; drive to Lac Rose via toll motorway  ·  40 km / 1h–1h15", "Lakeshore: salt harvesters, cooperative visit, salt-mound landscape  ·  60 min", "Boat tour on the lake  ·  25 min", "Quad excursion: dune belt crossing to the Atlantic beach (old Dakar Rally finish)  ·  12 km loop / 45–60 min", "Full-day: return to Dakar — end of service  ·  35 km / 1h"], "addons": [{"name": "Camel ride on the dunes (per person)", "price": 6000, "per": "person"}, {"name": "Horse ride", "price": 6000, "per": "booking"}, {"name": "4x4 / buggy upgrade instead of shared 4x4", "price": 40000, "per": "booking"}, {"name": "Lakeside lunch (per person)", "price": 10000, "per": "person"}, {"name": "Noflaye Turtle Village entry", "price": 3500, "per": "booking"}]}, {"id": "boat", "pole": "Dakar", "name": "Dakar Boat Party Tour — Oceane Cruise Senegal", "dur": "Half day or sunset", "tag": "Nightlife", "emoji": "⛵", "zone": "dakar", "desc": "Modern comfort boats off Ngor beach with catering, drinks and music — partner rated 4.9/5.", "quote": false, "grid": {"p12": {"a": 45000, "c": null}, "p34": {"a": 40000, "c": null}, "grp": {"a": 37000, "c": null}}, "sub": "Departs Plage de Ngor · partner: OCEANE CRUISE Sénégal (+221 77 801 98 98, daily 10:00–23:00, rated 4.9/5) · modern comfort boats · music, catering & drinks INCLUDED", "steps": ["Pick-up; transfer to Ngor beach; welcome by the Océane Cruise crew  ·  14 km / 30–40 min from Plateau", "Boarding; safety briefing; welcome drinks; music on board (DJ/sound system)  ·  20 min", "Cruise along the Dakar coastline: Ngor island, Almadies point, corniche cliffs and viewpoints  ·  90 min", "Anchor stop: swimming from the boat (conditions permitting); catering service on board — food & drinks included in the rate  ·  60–75 min", "Party cruise return leg with music; disembark at Ngor beach  ·  45 min", "Transfer back to hotel — end of service (sunset format: shift the whole program to 16:30–20:30)  ·  30–40 min"], "addons": [{"name": "Private full-boat charter (birthdays, bachelor(ette) parties, corporate)", "price": 190000, "per": "booking"}, {"name": "Event extras via Océane Cruise: decoration, photographer, cake, beach-dinner add-on", "price": null, "per": "booking"}, {"name": "Premium drinks upgrade", "price": null, "per": "booking"}]}, {"id": "food", "pole": "Dakar", "name": "Dakar Food Tour — Teranga on a Plate", "dur": "2h30", "tag": "Gastronomy", "emoji": "🍲", "zone": "dakar", "desc": "Medina, Soumbédioune and beach grills: thieboudienne, grilled fish, café Touba — eat like a Dakarois.", "quote": false, "grid": {"p12": {"a": 25000, "c": 15000}, "p34": {"a": 20000, "c": 10000}, "grp": {"a": 18000, "c": 5000}}, "sub": "Departure 10:00 (morning) or 17:30 (evening) · Medina + Soumbédioune + beach grills · walking + vehicle · groups 2–8 · max 2h30", "steps": ["Departure from the hotel", "Medina: authentic atmosphere; taste grilled meat with local sauces  ·  40 min", "Magic Land / Cassation Beach: grilled-fish outdoor restaurants — taste fresh grilled fish and seafood  ·  10 min transfer + 60 min", "Return to hotel — end of service (~12:30–13:00)  ·  20–30 min"], "addons": [{"name": "Evening variant: dibiterie + live-music venue (cover + drinks)", "price": 30000, "per": "booking"}, {"name": "Pointe des Almadies extension: grilled squid & lobster at Africa’s westernmost point", "price": 15000, "per": "booking"}, {"name": "Fast-food / quick-bite variant for time-limited clients", "price": 7000, "per": "booking"}, {"name": "Cooking-class upgrade: shop the market then cook with the host (3 pax)", "price": 25000, "per": "booking"}, {"name": "Vegetarian / dietary-adapted track (flag at booking)", "price": null, "per": "booking"}]}, {"id": "market", "pole": "Dakar", "name": "Dakar Market Experience", "dur": "Half day", "tag": "Culture", "emoji": "🧺", "zone": "dakar", "desc": "The shopping-focused Dakar: fabric, crafts and market energy with a negotiation-savvy guide.", "quote": false, "grid": {"p12": {"a": 25000, "c": 12500}, "p34": {"a": 15000, "c": 7500}, "grp": {"a": 10000, "c": 5000}}, "sub": "Departure 09:30 · vehicle + walking · 3–4 h · shopping-focused variant of the city tour", "steps": ["Pick-up; Soumbedioune craft market: woodwork, textiles, jewellery (fixed-price orientation first)  ·  45–60 min", "Sandaga or Tilène market: fabrics (wax, bazin), tailors' quarter — order same-day tailoring  ·  60 min", "HLM market: Senegal’s fabric capital — wax prints, brocades, trims  ·  60 min", "Drop-off at hotel or restaurant — end of service  ·  20–30 min"], "addons": [{"name": "Lunch after the markets (per person)", "price": 12000, "per": "person"}, {"name": "Shopping-porter / negotiation assistant", "price": 15000, "per": "booking"}]}, {"id": "galleries", "pole": "Dakar", "name": "Dakar Museums & Galleries Circuit", "dur": "Half or full day", "tag": "Culture", "emoji": "🎨", "zone": "dakar", "desc": "Museums and galleries circuit for art lovers — verify opening days, several close Mondays.", "quote": false, "grid": {"p12": {"a": 40000, "c": 20000}, "p34": {"a": 35000, "c": 15000}, "grp": {"a": 25000, "c": 10000}}, "sub": "Departure 09:30 · verify opening days (several close Mondays) · art-lover product", "steps": ["Museum of Black Civilizations — curated route  ·  90 min", "IFAN Museum of African Arts (masks, statuary, textiles of West Africa)  ·  60 min", "Lunch break downtown  ·  75 min", "Léopold Sédar Senghor Museum (presidential residence-museum)  ·  60 min", "Return transfer — end of service  ·  20–30 min"], "addons": [{"name": "Half-day version (MCN + IFAN only)", "price": 12000, "per": "booking"}, {"name": "Contemporary loop: Ousmane Sow Museum (sculptor’s house)", "price": 6000, "per": "booking"}, {"name": "National Gallery of Art", "price": 6000, "per": "booking"}, {"name": "OH Gallery", "price": 6000, "per": "booking"}]}, {"id": "bandia", "pole": "Petite Côte", "name": "Bandia Wildlife Reserve Safari", "dur": "From Dakar dep. 07:30 or from Saly dep. ", "tag": "Safari", "emoji": "🦒", "zone": "bandia", "desc": "Rhinos, giraffes, buffalo and antelope in open 4x4 — Senegal's classic morning safari, 1h from Dakar.", "quote": false, "grid": {"p12": {"a": 73500, "c": 36750}, "p34": {"a": 35000, "c": 17500}, "grp": {"a": 35000, "c": 17500}}, "sub": "From Dakar dep. 07:30 or from Saly dep. 08:30 · 2–3 h on site · morning strongly preferred", "steps": ["Pick-up Dakar (or 08:30 Saly); drive to Bandia gate  ·  65 km / 1h (Saly: 15 km / 20 min)", "Reserve formalities; board open safari truck (or client 4x4 + ranger)  ·  15 min", "Game drive: rhino & giraffe sectors, eland, zebra, antelope plains  ·  90 min", "Griot burial baobab and monumental baobabs; short walk  ·  20 min", "Waterhole restaurant deck: crocodiles, drinks stop  ·  10 min", "Return"], "addons": [{"name": "Waterhole drinks package", "price": null, "per": "booking"}, {"name": "Combo with Accrobaobab same day (combo rate)", "price": null, "per": "booking"}]}, {"id": "lions", "pole": "Petite Côte", "name": "Ranch of Lions — Lion Safari", "dur": "adjacent to Bandia", "tag": "Safari", "emoji": "🦁", "zone": "bandia", "desc": "4x4 drive in the lion enclosure adjacent to Bandia (~30 min) — clearly-labelled opt-in experience.", "quote": false, "grid": {"p12": {"a": 73500, "c": 36750}, "p34": {"a": 35000, "c": 17500}, "grp": {"a": 35000, "c": 17500}}, "sub": "Same access as Bandia/Ranch complex · 4x4 lion-enclosure drive ~30 min · opt-in product", "steps": ["Arrival at the lion park  ·  1–2 km from reserve gate", "Briefing; board dedicated 4x4 for the lion-enclosure safari  ·  15 min", "Drive among the lions with ranger commentary  ·  30 min", "Exit and return"], "addons": [{"name": "Lunch at Bandia reserve", "price": null, "per": "booking"}]}, {"id": "accro", "pole": "Petite Côte", "name": "Accrobaobab Adventure Park", "dur": "Sindia", "tag": "Adventure", "emoji": "🌳", "zone": "bandia", "desc": "Ziplines and rope courses strung between giant baobabs at Sindia. Height/weight limits apply.", "quote": false, "grid": {"p12": {"a": 25000, "c": 20000}, "p34": {"a": 22000, "c": 17000}, "grp": {"a": 20000, "c": 15000}}, "sub": "Sindia · 2–3 h on site · dep. Dakar 08:00 / Saly 09:00 or afternoon 15:00 slot · height/weight limits apply", "steps": ["Arrival; waivers, harness fitting, safety briefing  ·  30 min", "Course rotation by ability: children's circuit / discovery / sport / black course between giant baobabs  ·  90–120 min", "Debrief, photos, refreshments; depart"], "addons": [{"name": "Photo/video package by park staff", "price": null, "per": "booking"}, {"name": "Group team-building format (MICE, with facilitator)", "price": null, "per": "booking"}]}, {"id": "somone", "pole": "Petite Côte", "name": "Somone Lagoon Pirogue & Bird Sanctuary", "dur": "Tide-dependent — schedule around high wa", "tag": "Nature", "emoji": "🦩", "zone": "dakar", "desc": "Glide the lagoon at high tide among herons, pelicans and mangroves. Tide-dependent scheduling.", "quote": false, "grid": {"p12": {"a": 30000, "c": 20000}, "p34": {"a": 25000, "c": 17000}, "grp": {"a": 20000, "c": 15000}}, "sub": "Tide-dependent — schedule around high water · best 07:30–10:00 or 16:30–sunset · 2–3 h on water", "steps": ["Pick-up Dakar/Somone hotels; transfer to lagoon jetty  ·  12 km / 20 min", "Board pirogue; mangrove channels of the community reserve  ·  45 min", "Sandbank stop: pelicans, herons, terns (flamingos seasonal); mangrove-reforestation point  ·  30 min", "Lunch at CHEZ RASTA  ·  75 min", "Return"], "addons": [{"name": "Oyster-gathering demonstration + tasting", "price": 3000, "per": "booking"}, {"name": "Jet-ski or quad session after the pirogue", "price": 25000, "per": "booking"}, {"name": "Sunset honeymoon private pirogue with drinks", "price": null, "per": "booking"}]}, {"id": "joal", "pole": "Petite Côte", "name": "Joal-Fadiouth Shell Island", "dur": "From Saly dep. 09:00", "tag": "Heritage", "emoji": "🐚", "zone": "joal", "desc": "Fadiouth, the island built of clam shells, its stilt granaries and the shared Christian-Muslim cemetery.", "quote": false, "grid": {"p12": {"a": 20000, "c": 15000}, "p34": {"a": 17750, "c": 10000}, "grp": {"a": 15000, "c": 7500}}, "sub": "From Saly dep. 09:00 · 45 km / 50 min · half day (full day when combined with Somone)", "steps": ["Pick-up; coastal drive via Nguékokh–Joal  ·  45 km / 50 min", "Fadial giant baobab stop en route (one of Senegal’s largest)  ·  20 min", "Joal: Senghor family home / heritage points (exterior visits)  ·  30 min", "Cross the 800 m wooden footbridge to Fadiouth (no vehicles)  ·  15 min", "Guided walk: shell streets, church and mosque, granaries on stilts viewpoint  ·  60 min", "Second bridge / pirogue to the interfaith shell cemetery  ·  45 min", "Pirogue loop around granary islets or lunch in Joal  ·  45–75 min", "Return to Dakar — end of service  ·  45 km / 50 min"], "addons": [{"name": "Seafood lunch in Joal (per person)", "price": null, "per": "person"}, {"name": "Combo day with Somone Lagoon (sunset on return)", "price": null, "per": "booking"}]}, {"id": "ndangane", "pole": "Sine Saloum", "name": "Ndangane Activity Day — ‘Aventuriers du Saloum’ base", "dur": "Day format from Dakar (dep.8:30) or Saly", "tag": "Adventure", "emoji": "🚣", "zone": "ndangane", "desc": "'Aventuriers du Saloum' activity base: kayak, quad and pirogue days on the northern delta.", "quote": false, "grid": {"p12": {"a": 39900, "c": 35000}, "p34": {"a": 35000, "c": 28000}, "grp": {"a": 32500, "c": 25000}}, "sub": "Day format from Dakar (dep.8:30) or Saly (dep. 09:00) · partner activity base at Ndangane · family/group product", "steps": ["Depart Dakar or Saly  ·  2 h", "Visit of the giant baobab of Fadial — one of the largest and oldest baobabs in Senegal  ·  30 min", "Arrive Ndangane base; welcome and program briefing  ·  20 min", "Boat ride through the mangrove channels  ·  45 min", "Buffet lunch at the base  ·  90 min", "Aquatic & beach activities: water basketball, canoe, games (equipment on site)  ·  2h", "Return drive  ·  2h"], "addons": [{"name": "Overnight at hotel", "price": null, "per": "booking"}]}, {"id": "keurpapaye", "pole": "Sine Saloum", "name": "Keur Papaye Island Day", "dur": "from Djifer", "tag": "Nature", "emoji": "🏝️", "zone": "palmarin", "desc": "Motor-pirogue from Djifer to Keur Papaye island — delta sandbanks, birds and a castaway lunch.", "quote": false, "grid": {"p12": {"a": 70000, "c": 35000}, "p34": {"a": 47000, "c": 23500}, "grp": {"a": 35000, "c": 17500}}, "sub": "Dep. Dakar or Saly 09:00 → Djifer / 2h", "steps": ["Depart to Djifer  ·  2h", "Boat ride departure  ·  30 min", "Arrive Keur Papaye, welcome cocktail and lunch  ·  90 min", "Free time: beach, swimming pool (towels provided), or horse-cart ride to the village  ·  2h", "Return boat + drive — end of service Saly ~18:30  ·  2h boat + 1h30 drive"], "addons": [{"name": "Private pirogue upgrade", "price": 40000, "per": "booking"}, {"name": "Overnight at hotel", "price": null, "per": "booking"}]}, {"id": "grandsaloum", "pole": "Sine Saloum", "name": "Grand Saloum Islands Boat Tour — Palmarin · Djifere · Falia", "dur": "Dep. Palmarin/Djifer by motor-pirogue", "tag": "Nature", "emoji": "⛵", "zone": "palmarin", "desc": "Full day on the water from Palmarin/Djifer: the grand tour of the Saloum shell islands.", "quote": false, "grid": {"p12": {"a": 80000, "c": 40000}, "p34": {"a": 70000, "c": 35000}, "grp": {"a": 60000, "c": 20000}}, "sub": "Dep. Palmarin/Djifer by motor-pirogue · full day on the water · the ‘Great Islands Tour’", "steps": ["Board in a motorized pirogue for the Great Sine Saloum Islands Tour", "Traditional salt wells of Palmarin: harvest explanation  ·  30 min", "Djifere: fishermen’s return and the lively fish-landing market  ·  60 min", "Cruise to ‘No Stress’ island; picnic on the sandbank  ·  2h incl. picnic", "Falia village walk: shell mounds, Serer-Niominka life  ·  30 min", "Paddle through the mangroves in a traditional canoe  ·  30 min", "Return  ·  -"], "addons": [{"name": "Overnight at Palmarin or Keur Papaye", "price": null, "per": "booking"}]}, {"id": "toubacouta", "pole": "Sine Saloum", "name": "Toubacouta — Mangroves, Bird Roost & Shell Islands", "dur": "core, 1–3 days", "tag": "Nature", "emoji": "🌿", "zone": "toubacouta", "desc": "The delta at its purest: bolongs by pirogue, the sunset bird roost and islands built of shells.", "quote": false, "grid": {"p12": {"a": 70000, "c": 65000}, "p34": {"a": 59500, "c": 54500}, "grp": {"a": 55000, "c": 50000}}, "sub": "Dep. Dakar 07:00 · 250 km / 4h30 · minimum 1 night (roost is at dusk) · lodge tiers: eco / mid / premium", "steps": ["Departure to Fathala  ·  250 km / 4h30", "Lion walk  ·  25 min", "Lunch at hotel  ·  90 min", "Boat tour in the mangrove and visit of seashell island  ·  2h", "Return"], "addons": [{"name": "Oyster & seafood tasting platter", "price": null, "per": "booking"}, {"name": "Fishing with local pirogue crew", "price": null, "per": "booking"}, {"name": "Visit village of Toubacouta", "price": null, "per": "booking"}, {"name": "Overnight stay at hotel", "price": null, "per": "booking"}]}, {"id": "ziguinchor", "pole": "Casamance", "name": "Ziguinchor City & River", "dur": "half or full day", "tag": "Culture", "emoji": "🛖", "zone": "ziguinchor", "desc": "Casamance's river capital: markets, craft village and a bolong pirogue on the north bank.", "quote": false, "grid": {"p12": {"a": 90000, "c": 45000}, "p34": {"a": 40000, "c": 20000}, "grp": {"a": 34000, "c": 17000}}, "sub": "Dep. 09:00 from Ziguinchor hotels · walking + vehicle + pirogue", "steps": ["Colonial riverfront and Escale quarter walk; cathedral  ·  30 min", "Marché Saint-Maur guided walk (crafts, produce)  ·  30 min", "Artisan village workshops  ·  30 min", "Lunch break  ·  25 min", "Pirogue on the Casamance river to Îlot aux Oiseaux (pelicans, mangrove birds)  ·  2h", "Return — end of service / connect to circuit"], "addons": [{"name": "River-fish lunch on the quay (per person)", "price": null, "per": "person"}, {"name": "Diola-culture briefing session with historian", "price": null, "per": "booking"}]}, {"id": "capskirring", "pole": "Casamance", "name": "Cap Skirring Beach Base", "dur": "1–7 days", "tag": "Beach", "emoji": "🏖️", "zone": "capskirring", "desc": "Casamance's palm-lined beaches as your base for island and village excursions, 1–7 days.", "quote": false, "grid": {"p12": {"a": 98000, "c": 88000}, "p34": {"a": 55000, "c": 45000}, "grp": {"a": 40000, "c": 30000}}, "sub": "Transfer airport→hotels 5–10 km / 15 min · activity menu within 45 min radius", "steps": ["Day 1: Arrival and airport pick-up  ·  15 min transfer", "Day 2 am: Museum of Kadioute, King of Oussouye, Eloubaline island, boat tour  ·  full day", "Day 2 pm: Beach / pool free time", "Day 3: Departure and airport drop-off  ·  15 min transfer"], "addons": [{"name": "Golf green fee (per round)", "price": 25000, "per": "booking"}, {"name": "Fishing charter (per boat, half day)", "price": 30000, "per": "booking"}, {"name": "Kayak hire (per hour)", "price": 5000, "per": "booking"}, {"name": "Seafood beach-grill dinner (per person)", "price": 15000, "per": "person"}, {"name": "Diembéring viewpoint & giant fromagers sunset trip", "price": 5000, "per": "booking"}]}, {"id": "oussouye", "pole": "Casamance", "name": "Oussouye & Island Adventure", "dur": "full day", "tag": "Culture", "emoji": "👑", "zone": "capskirring", "desc": "The kingdom of Oussouye combined with a Casamance island adventure — kayaking, Pointe Saint-Georges, Wendaye and Carabane island.", "quote": false, "grid": {"p12": {"a": 98000, "c": 88000}, "p34": {"a": 48000, "c": 38000}, "grp": {"a": 38000, "c": 28000}}, "sub": "Dep. Cap Skirring 09:00 · 20 km / 30 min to Oussouye · sacred-site protocol briefing mandatory", "steps": ["Depart to Oussouye", "Visit to the King of Oussouye and discovery of local traditions and culture  ·  60 min", "Kayaking experience in Casamance  ·  90 min", "Pointe Saint-Georges platform: climb up for the panoramic views  ·  30 min", "Wendaye Island: local honey production site  ·  60 min", "Carabane Island by boat/pirogue: island exploration  ·  120 min", "Return to hotel — end of service"], "addons": [{"name": "Host-family village lunch (per person)", "price": 10000, "per": "person"}, {"name": "Edioungou pottery workshop with purchase credit", "price": 5000, "per": "booking"}, {"name": "King's-audience protocol gift (customary, handled by guide)", "price": 5000, "per": "booking"}]}, {"id": "capdiscovery", "pole": "Casamance", "name": "Cap Skirring Discovery Day — Cap Saint-Georges, Elinkine & Wenday Island", "dur": "Dep. Cap Skirring 08:30", "tag": "Beach", "emoji": "🌅", "zone": "capskirring", "desc": "Cap Saint-Georges and Elinkine in one full day — Casamance's coast by vehicle and boat.", "quote": false, "grid": {"p12": {"a": 63000, "c": null}, "p34": {"a": 35000, "c": null}, "grp": {"a": 25000, "c": null}}, "sub": "Dep. Cap Skirring 08:30 · vehicle + boat combination · full day · combines coast, king’s domain and islands", "steps": ["Depart Cap Skirring; Cap Saint-Georges viewpoint and fishing beach  ·  10 km / 25 min", "Oussouye: royal domain surroundings and protocol visit (audience if granted — see Oussouye & Mlomp protocol rules)  ·  20 km / 40 min + 60 min", "Elinkine fishing village: pirogue port life  ·  15 km / 25 min + 45 min", "Boat tour of the bolongs; landing on Wenday island (beach + village)  ·  2h incl. stop", "Return to Cap Skirring — end of service ~17:00  ·  35 km / 55 min"], "addons": [{"name": "Late seafood lunch at Elinkine or island picnic", "price": null, "per": "booking"}, {"name": "Carabane Island extension instead of Wenday", "price": null, "per": "booking"}]}, {"id": "carabane", "pole": "Casamance", "name": "Carabane Island", "dur": "full day or overnight", "tag": "Heritage", "emoji": "⚓", "zone": "capskirring", "desc": "The historic island trading post at the mouth of the Casamance river — full day or overnight.", "quote": true, "grid": {"p12": {"a": null, "c": null}, "p34": {"a": null, "c": null}, "grp": {"a": null, "c": null}}, "sub": "Dep. Cap Skirring 08:30 → Elinkine 35 km / 55 min → pirogue 30 min", "steps": ["Depart Cap Skirring via Oussouye to Elinkine fishing village  ·  35 km / 55 min", "Pirogue crossing (estuary dolphins frequent)  ·  6 km / 30 min", "Guided walk: mission church ruins, colonial cemetery, village lanes  ·  90 min", "Beach / hammock time; seafood lunch at guesthouse  ·  2h", "Mangrove-edge walk or second swim  ·  60 min", "Return pirogue + drive — end of service (or overnight in guesthouse)  ·  1h30 total"], "addons": [{"name": "Guesthouse overnight (per person half-board)", "price": null, "per": "person"}, {"name": "Private sunset pirogue return", "price": null, "per": "booking"}, {"name": "Dolphin-watching extended loop", "price": null, "per": "booking"}]}, {"id": "bolongs", "pole": "Casamance", "name": "Bolongs, Oyster Villages & Affiniam", "dur": "full day", "tag": "Nature", "emoji": "🦪", "zone": "ziguinchor", "desc": "Bolongs, oyster villages and Affiniam by pirogue, with a village lunch on the north bank.", "quote": true, "grid": {"p12": {"a": null, "c": null}, "p34": {"a": null, "c": null}, "grp": {"a": null, "c": null}}, "sub": "Dep. Ziguinchor 08:30 · pirogue north bank · village lunch centrepiece", "steps": ["Board pirogue at Ziguinchor; cross to north-bank bolongs  ·  45–60 min", "Affiniam: giant case à impluvium, village walk, women's processing cooperative  ·  2h", "Mangrove oyster culture demonstration + tasting  ·  45 min", "Village lunch with family (rice-paddy landscape)  ·  90 min", "Return pirogue via smaller bolongs, birdlife  ·  60–75 min", "End of service Ziguinchor"], "addons": [{"name": "Cooperative products purchase pack (fruit, cashew, pottery)", "price": null, "per": "booking"}, {"name": "Extended birding loop with specialist guide", "price": null, "per": "booking"}]}, {"id": "ferry", "pole": "Casamance", "name": "Casamance Ferry Experience", "dur": "Dakar ⇄ Ziguinchor", "tag": "Adventure", "emoji": "🚢", "zone": "", "desc": "The legendary overnight ferry Dakar ⇄ Ziguinchor via Carabane — cabins and sea sunset.", "quote": true, "grid": {"p12": {"a": null, "c": null}, "p34": {"a": null, "c": null}, "grp": {"a": null, "c": null}}, "sub": "Overnight sailing ~15–16 h via Carabane · cabins 2/4 berth + seats · verify weekly schedule & book early", "steps": ["Day 1: ATS transfer to Dakar ferry terminal; check-in, cabin allocation  ·  20–30 min", "17:00 (typ.): Departure — sunset past Gorée from deck (confirm current sailing time)", "Night: At sea along the coast; dinner on board", "Day 2 dawn: Entry into the Casamance river; Carabane call; mangrove approach  ·  2–3 h river leg", "Day 2 ~: Arrive Ziguinchor; ATS meet & greet at the quay"], "addons": [{"name": "Cabin class upgrade (4-berth → 2-berth)", "price": null, "per": "booking"}, {"name": "On-board dinner package", "price": null, "per": "booking"}, {"name": "Carabane disembark option (start circuit on the island)", "price": null, "per": "booking"}]}, {"id": "stlouis", "pole": "Saint-Louis", "name": "Saint-Louis Island Heritage Tour", "dur": "half day", "tag": "Heritage", "emoji": "🌉", "zone": "stlouis", "desc": "The UNESCO former capital by calèche and on foot: Faidherbe bridge, colonial island, Guet Ndar.", "quote": false, "grid": {"p12": {"a": 15000, "c": 10000}, "p34": {"a": 10000, "c": 7000}, "grp": {"a": 7500, "c": 5000}}, "sub": "Dep. 09:00 or 15:30 from Saint-Louis hotels · calèche + walking · UNESCO island", "steps": ["Calèche (horse-cart) circuit: colonial grid, balconied houses, Governor's quarter, cathedral  ·  75 min", "Walking: signares heritage, Museum of Photography (MuPho), craft galleries, riverfront  ·  60 min", "Guet Ndar fishing quarter: pirogue landing beach (small groups, local guide, ask-before-photo)  ·  60 min", "End of service on the island"], "addons": [{"name": "Island lunch (colonial-house restaurant, per person)", "price": 5000, "per": "person"}, {"name": "Photography-focused sunset variant (dep. 15:30, ends at Guet Ndar landing)", "price": null, "per": "booking"}, {"name": "Jazz-history walk (festival season)", "price": null, "per": "booking"}]}, {"id": "djoudj", "pole": "Saint-Louis", "name": "Djoudj National Bird Sanctuary", "dur": "Nov–Apr", "tag": "Wildlife", "emoji": "🦜", "zone": "stlouis", "desc": "One of the world's great bird sanctuaries — pelican colonies by boat safari (Nov–Apr).", "quote": false, "grid": {"p12": {"a": 35000, "c": 30000}, "p34": {"a": 30000, "c": 25000}, "grp": {"a": 25000, "c": 20000}}, "sub": "Dep. Saint-Louis 07:00 · 60 km / 1h15 · boat safari ~2h · park fee + boat fee", "steps": ["Depart Saint-Louis (early = best light and bird activity)  ·  60 km / 1h15", "Park formalities; board boat at the quay  ·  30 min", "Boat safari to the great white-pelican breeding colony; flamingos, cormorants, spoonbills; crocodiles and warthogs on banks  ·  2h", "Observation tower / short drive circuit in the park  ·  45 min", "Return to Saint-Louis — end of service ~12:45  ·  60 km / 1h15"], "addons": [{"name": "Private boat (photographers)", "price": null, "per": "booking"}, {"name": "Picnic in the park", "price": null, "per": "booking"}]}, {"id": "barbarie", "pole": "Saint-Louis", "name": "Langue de Barbarie", "dur": "Dep. Saint-Louis 08:30 or 15:30", "tag": "Nature", "emoji": "🐢", "zone": "stlouis", "desc": "Langue de Barbarie national park: pirogue between river and ocean, birds and turtle beaches.", "quote": false, "grid": {"p12": {"a": 20000, "c": 15000}, "p34": {"a": 15000, "c": 10000}, "grp": {"a": 10000, "c": 7500}}, "sub": "Dep. Saint-Louis 08:30 or 15:30 · 20 km / 40 min · pirogue + 4x4", "steps": ["Depart Saint-Louis south along the Langue de Barbarie  ·  20 km / 40 min", "Pirogue between river and ocean: tern/gull colonies (strongest in nesting season)  ·  90 min", "Return — end of service ~12:30  ·  40 min"], "addons": [{"name": "Geumbeul reserve", "price": 10000, "per": "booking"}, {"name": "Ranch of Bango", "price": 12000, "per": "booking"}]}, {"id": "lompoul", "pole": "Saint-Louis", "name": "Lompoul Desert Overnight", "dur": "en-route module", "tag": "Adventure", "emoji": "🏜️", "zone": "lompoul", "desc": "Orange dunes, camel rides and a night in a desert camp between Dakar and Saint-Louis.", "quote": false, "grid": {"p12": {"a": 50000, "c": 35000}, "p34": {"a": 45000, "c": 31500}, "grp": {"a": 40000, "c": 28000}}, "sub": "Dep. Dakar → camp for sunset · 150 km / 2h30–3h · continue to Saint-Louis next morning (115 km / 1h45)", "steps": ["Depart Dakar (or 09:00 if sold as day 1 standalone)  ·  150 km / 2h30", "4x4 shuttle from village to the dune camp  ·  4 km / 15 min", "Camel ride in the dunes and sandboarding  ·  90 min", "Dinner and cultural night  ·  evening", "Day 2: Breakfast and check out  ·  90 min", "Depart to Saint-Louis  ·  115 km / 1h45"], "addons": [{"name": "Quad tour in the dunes", "price": 35000, "per": "booking"}, {"name": "Paintball session (camp-dependent)", "price": 10000, "per": "booking"}, {"name": "Private dune dinner (honeymoon)", "price": null, "per": "booking"}]}, {"id": "kedafia", "pole": "Kédougou", "name": "Hafia Shea Butter Workshop", "dur": "Full day", "tag": "Culture", "emoji": "💧", "zone": "kedougou", "desc": "A day in Hafia with the women shea cooperative — the full karité butter transformation, hands-on.", "quote": false, "grid": {"p12": {"a": 30000, "c": 25000}, "p34": {"a": 18000, "c": 13000}, "grp": {"a": 17000, "c": 10000}}, "sub": "Around Kédougou town · flexible slots to fill circuit days", "steps": ["Road to Hafia  ·  1 h", "Meet the women transforming shea butter  ·  20 min", "Shea butter transformation process, hands-on  ·  4 h", "Return to Kédougou  ·  1 h"], "addons": [{"name": "Ethiolo village: terraced hills, palm groves, initiation-culture explanations", "price": null, "per": "booking"}, {"name": "Overnight at camp", "price": null, "per": "booking"}]}, {"id": "kediwol", "pole": "Kédougou", "name": "Iwol & Bedik Village Day", "dur": "Full day", "tag": "Culture", "emoji": "⛰️", "zone": "kedougou", "desc": "Climb to the Bedik hilltop village of Iwol — sacred fromagers, shrines and initiation culture, then a swim in the plunge pool near Bandafassi.", "quote": false, "grid": {"p12": {"a": 26000, "c": 21000}, "p34": {"a": 17000, "c": 12000}, "grp": {"a": 15000, "c": 10000}}, "sub": "Dep. Kédougou 08:00 · 35 km / 1h (last section piste) · forest walk 30–45 min each way · community reserve fee", "steps": ["Depart Kédougou to Iwol  ·  20 min", "Meet the village guide; briefing on protocol and photo rules  ·  15 min", "Climb to Iwol hilltop village  ·  60 min", "Village visit: sacred fromager, shrines, church, thatched-cone quarter; host explanations of initiation cycles  ·  2 h", "Departure for Bandafassi  ·  30 min", "Swim in the plunge pool; photos  ·  60 min", "Return to Kédougou — end of service"], "addons": [{"name": "Lunch", "price": null, "per": "booking"}]}, {"id": "classic7", "pole": "Grand Tours", "name": "Classic Senegal — 7 days / 6 nights", "dur": "7 days / 6 nights", "tag": "Circuit", "emoji": "🌍", "zone": "", "desc": "The essential week: Dakar, Gorée, Pink Lake, the Lompoul desert, Saint-Louis and a Bandia safari.", "quote": true, "grid": {"p12": {"a": null, "c": null}, "p34": {"a": null, "c": null}, "grp": {"a": null, "c": null}}, "sub": "Total driving ~700 km · year-round (Djoudj Nov–Apr, else Langue de Barbarie) · guaranteed weekly departures Nov–Apr", "steps": ["Dakar arrival & welcome dinner", "Dakar City Tour + Gorée Island", "Pink Lake → Lompoul desert camp", "Saint-Louis heritage tour", "Djoudj (or Langue de Barbarie) → drive south", "Bandia safari → Accrobaobab or Somone", "Renaissance Monument → AIBD departure"], "addons": []}, {"id": "northdelta10", "pole": "Grand Tours", "name": "Senegal North & Delta — 10 days / 9 nights", "dur": "10 days / 9 nights", "tag": "Circuit", "emoji": "🌍", "zone": "", "desc": "The Classic Senegal spine extended with the full Sine Saloum delta — Fathala, shell islands and the bird roost.", "quote": true, "grid": {"p12": {"a": null, "c": null}, "p34": {"a": null, "c": null}, "grp": {"a": null, "c": null}}, "sub": "Classic Senegal spine + full Sine Saloum · total driving ~1,000 km", "steps": ["Classic Senegal days 1–5 (Dakar, Gorée, Pink Lake, Lompoul, Saint-Louis)", "Drive Saint-Louis → Saly", "Bandia Reserve + Accrobaobab", "Joal-Fadiouth → Palmarin lagoons", "Toubacouta: bolong pirogue + evening bird roost", "Fathala lion walk + shell islands", "Return to Dakar / AIBD"], "addons": []}, {"id": "grandtour14", "pole": "Grand Tours", "name": "Grand Tour of Senegal — 13–14 days", "dur": "13–14 days", "tag": "Circuit", "emoji": "🌍", "zone": "", "desc": "The flagship: Senegal North & Delta plus Casamance by air or ferry — the full country end to end.", "quote": true, "grid": {"p12": {"a": null, "c": null}, "p34": {"a": null, "c": null}, "grp": {"a": null, "c": null}}, "sub": "Senegal North & Delta + Casamance by air (or ferry option) · the flagship", "steps": ["Senegal North & Delta (days 1–9)", "Toubacouta → flight to Ziguinchor / Cap Skirring", "Oussouye kingdom & Mlomp", "Carabane island day", "Cap Skirring beach day; sunset at Diembéring", "Fly Cap Skirring/Ziguinchor → Dakar → departure (ferry variant available)"], "addons": []}, {"id": "wild12", "pole": "Grand Tours", "name": "Wild Senegal — 12–13 days", "dur": "12–13 days · Nov–May", "tag": "Adventure", "emoji": "🌍", "zone": "", "desc": "Adventure segment, 4x4 throughout: Niokolo-Koba big game, Kédougou and the Bassari country of the far east.", "quote": true, "grid": {"p12": {"a": null, "c": null}, "p34": {"a": null, "c": null}, "grp": {"a": null, "c": null}}, "sub": "Adventure segment · 4x4 throughout · ~2,300 km total driving · Nov–May only · honest expectation-setting mandatory", "steps": ["Dakar arrival; briefing dinner", "Dakar essentials: City Tour + Gorée", "Dakar → Toubacouta: bolong pirogue + bird roost", "Fathala lion walk → Tambacounda", "Niokolo-Koba full day (Simenti / Wassadou)", "Gambia river sunset → Kédougou", "Dindéfélo waterfall & plateau", "Iwol & Bedik hilltops; Bassari country", "Return via Tambacounda → Saly → Dakar"], "addons": []}, {"id": "gambia10", "pole": "Grand Tours", "name": "Senegal & The Gambia — 9–10 days", "dur": "9–10 days", "tag": "Circuit", "emoji": "🌍", "zone": "", "desc": "A two-country journey via the Senegambia bridge — Dakar essentials, Bandia, Fathala and the Gambia river.", "quote": true, "grid": {"p12": {"a": null, "c": null}, "p34": {"a": null, "c": null}, "grp": {"a": null, "c": null}}, "sub": "Two-country product via Senegambia bridge · passports/visa check per nationality at quote", "steps": ["Dakar arrival + essentials (City Tour + Gorée)", "Dakar → Saly via Bandia safari", "Saly → Joal-Fadiouth → Toubacouta; bird roost", "Fathala lion walk → Karang border → Gambia river lodge", "Gambia: Kunta Kinteh island, Banjul & Bakau", "Gambia beach day", "Fly Banjul → Dakar (or drive back via Toubacouta)"], "addons": []}, {"id": "diaspora9", "pole": "Grand Tours", "name": "Diaspora Roots Journey — 8–9 days", "dur": "8–9 days", "tag": "Heritage", "emoji": "🕊️", "zone": "", "desc": "A high-emotion memory journey with historian guides — Gorée, Black Civilisations, Saint-Louis and Saloum ancestry.", "quote": true, "grid": {"p12": {"a": null, "c": null}, "p34": {"a": null, "c": null}, "grp": {"a": null, "c": null}}, "sub": "High-emotion premium product · historian guides only · ceremonies arranged with communities, never staged", "steps": ["Arrival; private briefing with historian guide", "Extended Gorée day: House of Slaves, IFAN, private commemoration", "Museum of Black Civilisations + Renaissance Monument", "Pink Lake + Lebou culture day", "Dakar → Saint-Louis: signares-history walk", "Djoudj (Nov–Apr) or Langue de Barbarie → south to Saly", "Saloum ancestry: Joal-Fadiouth + Palmarin & Toubacouta", "Community naming-ceremony day + closing dinner"], "addons": []}];
const POLES = ["All", "Dakar", "Petite Côte", "Sine Saloum", "Casamance", "Saint-Louis", "Kédougou", "Grand Tours"];
const VEHICLES = [
  { name: "Renault Mégane", cap: 3, bags: 2, type: "Berline", slug: "standard-sedan" }, { name: "Honda Accord", cap: 3, bags: 2, type: "Berline", slug: "premium-sedan" }, { name: "Mercedes-Benz S-Class", cap: 3, bags: 3, type: "Berline", slug: "luxury-sedan" },
  { name: "Standard SUV", cap: 4, bags: 3, type: "SUV", slug: "standard-suv" }, { name: "Toyota Prado VX", cap: 4, bags: 3, type: "SUV", slug: "premium-suv" }, { name: "Toyota Land Cruiser LC300", cap: 4, bags: 4, type: "SUV", slug: "luxury-suv" },
  { name: "Standard Van", cap: 14, bags: 8, type: "Van", slug: "standard-minivan" }, { name: "Premium Van", cap: 7, bags: 5, type: "Van", slug: "premium-minivan" }, { name: "Luxury Van", cap: 7, bags: 5, type: "Van", slug: "luxury-minivan" },
...
export default function ATSPlatformPreview() {
  ...
  const saveRecord = async (b) => {
    if (user) {
      ...
      const memEmail = b.contact?.email || user.email || "";
      if (memEmail) supabase.functions.invoke("send-confirmation", { body: { to: memEmail, name: b.contact?.name || user.name || "", kind, summary: bookingSummary(b) } }).catch(() => {});
      return rec;
    }
    ...
    <>
      <header style={{ background: T.ink }}>
        ...
        <div style={{
          ...
          background: `linear-gradient(rgba(0,0,0,.62), rgba(0,0,0,.62)), url("${heroUrl}") center bottom/cover no-repeat, linear-gradient(160deg, #006B33 0%, ${T.green} 65%, #00A84F 100%)`,
        }}>
...
function AdminConsole({ user, isAdmin, isSuper, setSignin }) {
  ...
  const tabs = [["bookings", "Bookings"], ["payments", "Payments"], ["users", "Users & roles"], ["orgs", "Corporate"], ["codes", "Promo codes"], ["commissions", "Commissions"], ["analytics", "Analytics"], ["activity", isSuper ? "Activity (all)" : "Activity"]];
...
// Local fallbacks for official vehicle photos not yet in the storage bucket.
// Supabase photos override these once uploaded (spread last).
const LOCAL_VEHICLE_PHOTOS = { "luxury-suv": "/vehicles/luxury-suv.png", "luxury-sedan": "/vehicles/luxury-sedan.jpg" };
const useVehiclePhotoMap = () => { const m = usePhotoMap("vehicles"); return { ...LOCAL_VEHICLE_PHOTOS, ...m }; };
...
const CARS = [
  ...
  { id: "prado", name: "Toyota Prado VX", type: "4X4", year: 2022, seats: 7, bags: 4, transmission: "Automatic", fuel: "Diesel", daily: 90000, location: "Dakar", available: true, slug: "prado-vx" },
...
// Home-style vehicle browse grids — used on the Home block AND the Transport page.
// Mobile: collapse to one horizontal scrolling row (see .tp-grid rule).
const TP_GRID_MOBILE = `@media(max-width:760px){.tp-grid{grid-template-columns:none!important;grid-auto-flow:column;grid-auto-columns:min(240px,74vw);overflow-x:auto;padding-bottom:10px;-webkit-overflow-scrolling:touch;scroll-snap-type:x proximity}.tp-grid>button{scroll-snap-align:start}}`;
const tpCardBase = { background: "#fff", border: `1px solid ${T.line}`, borderRadius: 16, overflow: "hidden", display: "flex", flexDirection: "column", textAlign: "left", cursor: "pointer", padding: 0, fontFamily: "inherit" };

function TransferVehicleGrid({ go }) {
  const vmap = useVehiclePhotoMap();
  return (
    <>
      <style>{TP_GRID_MOBILE}</style>
      <div className="tp-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(230px, 1fr))", gap: 16 }}>
        {VEHICLES.map((v, i) => (
          <button key={v.slug} className="card-hover" style={tpCardBase} onClick={() => go("vehicle", { mode: "transfer", id: v.slug })}>
  ...
  return (
    <>
      ...
      <div className="tp-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(250px, 1fr))", gap: 16 }}>
        {CARS.map((car) => (
          <button key={car.id} disabled={!car.available} className={car.available ? "card-hover" : ""} style={{ ...tpCardBase, cursor: car.available ? "pointer" : "not-allowed", opacity: car.available ? 1 : 0.6 }} onClick={() => car.available && go("vehicle", { mode: "rental", id: car.id })}>
...
function HomeTransportPicker({ go }) {
  ...
  return (
    <div>
      ...
      {tab === "transfer" ? <TransferVehicleGrid go={go} /> : <CarVehicleGrid go={go} />}
    </div>
  );
}
    ...
    <Wrap>
      ...
      <div className="veh-cols" style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(320px, 420px)", gap: 24, alignItems: "stretch" }}>
        ...
        <div style={card}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", gap: 12, marginTop: 16 }}>
            <div><div className="disp" style={{ fontWeight: 800, fontSize: 24, color: T.green }}>{fmtXOF(daily)}<span style={{ fontSize: 12, fontWeight: 500, opacity: 0.6 }}> /day</span></div>{days > 0 && <div style={{ fontSize: 12, opacity: 0.7 }}>Total {days}d: <strong>{fmtXOF(total)}</strong></div>}<div style={{ fontSize: 11.5, opacity: 0.6, marginTop: 2 }}>Dakar only — rate varies outside Dakar.</div></div>
            <button disabled={!ready} style={{ ...btnGold, marginLeft: "auto", opacity: ready ? 1 : 0.55, cursor: ready ? "pointer" : "not-allowed" }} onClick={book}>Book →</button>
          </div>
    ...
    <div style={{ background: "#fff", border: `1px solid ${T.line}`, borderRadius: 16, padding: compact ? 16 : 22 }}>
      ...
      <div className="hero-fields" style={{ display: "flex", gap: 10, alignItems: "stretch" }}>
        <HSelect Ico={Route} label="Route" value={dirI} onChange={setDirI} popWidth={260}
          options={TRANSFER_DIRECTIONS.map((d, i) => ({ v: i, label: `${d.from} → ${d.to}` }))} />
        {/* Vehicle — opens the photo picker popup */}
        <div style={{ ...heroBox, position: "relative", cursor: "pointer" }} onClick={() => setPicker(true)} role="button" aria-haspopup="dialog" aria-expanded={picker}>
          {vmap[veh.slug]
            ? <img src={vmap[veh.slug]} alt="" style={{ width: 48, height: 32, objectFit: "contain", flexShrink: 0 }} />
            : <Car size={19} color={T.green} strokeWidth={2} style={{ flexShrink: 0 }} />}
          <div style={{ minWidth: 0, flex: 1 }}>
      ...
      <div style={{ marginTop: 10, display: "flex", alignItems: "baseline", gap: 8, flexWrap: "wrap" }}>
        <span className="disp" style={{ fontWeight: 800, fontSize: 18, color: T.green }}>{fmtXOF(price)}</span>
        <span style={{ fontSize: 12, opacity: 0.6 }}>per vehicle · fixed rate</span>
      </div>
...
function CarRentalWidget({ addBooking, user, initial, onSearched }) {
  ...
  useEffect(() => { onSearched && onSearched(!!(searched && canSearch)); }, [searched, canSearch, onSearched]);
                      ...
                      <>
                        ...
                        <div style={{ marginTop: "auto", display: "flex", alignItems: "flex-end", gap: 10 }}>
                          <div>
                            ...
                            <div style={{ fontSize: 11.5, opacity: 0.6, marginTop: 2 }}>Dakar only — rate varies outside Dakar.</div>
                          </div>
                          {car.available
    ...
    <Wrap>
      ...
      {tab === "transfers" ? (
        <div style={{ display: "grid", gap: 22 }}>
          ...
          <TransferVehicleGrid go={go} />
        </div>
      ) : (
        <div style={{ display: "grid", gap: 22 }}>
          <CarRentalWidget addBooking={addBooking} user={user} initial={initialRental} onSearched={setRentalSearched} />
          {!rentalSearched && <CarVehicleGrid go={go} />}
        </div>
      )}
    </Wrap>
  );
